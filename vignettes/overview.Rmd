...
4. My `R CMD Check` passes everything except for __1 NOTE__: my README files are not usually part of the home package directory. My guess is that for a package trying to be published to CRAN, the README files should be omitted, but if it;s published to GitHub, then the README files should definitely exist.
